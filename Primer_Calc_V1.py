...
oligo_c = (oligo1_conc) * 1e-6 #Adjust primer concentration to mol/L
...
def primer1_salt_correction(primer1_melting_temperature, primer1_gc, primer1_length, mg, mon):
    ...
    a, b, c, d, e, f, g = 3.919e-5, -2.88e-5, 3.603e-5, 2.322e-5, -3.507e-4, 4.711e-4, 6.52e-5 #General constants
    const_a,const_b,const_c,const_d,const_e,const_f,const_g,const_h = -0.1156,-2.0725,-0.1445,6.247e-3,6.131e-3,0.0314,0.5308,4.563e-3 #Constants to regulate balance between Mg2+ and Na+
